...
/**
 * Payload model for creating a GitHub repository.
...
public class CreateRepoPayload {
    ...
    public CreateRepoPayload() {
    }

    private CreateRepoPayload(Builder builder) {
    ...
    public static class Builder {
        ...
        public CreateRepoPayload build() {
            return new CreateRepoPayload(this);
        }
    }
}
